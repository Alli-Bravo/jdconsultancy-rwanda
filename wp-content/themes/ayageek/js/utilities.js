(function($) {
	...
	$( document ).ready(function() {
		...
		ayageek_mainMenuInit();

		$('.grid').masonry();

		if (ayageek_options && ayageek_options.loading_effect) {
			ayageek_init_loading_effects();
		}
   ...
   $('.sub-menu-item-toggle').on('click', function(e) {
	...
	function ayageek_mainMenuClear() {
	...
	function ayageek_init_loading_effects() {
